<template>
  <div class="bg-gray-800 rounded-lg p-4 flex flex-col sm:flex-row">
    <img v-if="post.image" :src="createURl(post.image, 480, 320)" alt="post img" class="block w-full sm:max-w-xs mr-4 object-cover mb-4 sm:mb-0" />
...
import {createURl, formatDate} from '@/utils/helper'
